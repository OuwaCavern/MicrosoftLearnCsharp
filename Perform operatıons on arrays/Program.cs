...
//Resizing an array. Resizing to a larger size will add null items to the start of the array while resizing to a smaller size will remove last elements from an array.
/* string[] pallets = { "B14", "A11", "B12", "A13" };
Console.WriteLine("");
